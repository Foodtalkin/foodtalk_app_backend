...
class AdwordsController extends SiteBaseController
{
	/**
...
// 		$this->loadModel($id)->delete();
	...
	{
		$dataProvider=new CActiveDataProvider('Adwords');
...
// 			$model->attributes=$_GET['Adwords'];
	 ...
	 * @return Adwords the loaded model
	 ...
	 * @param Adwords $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='adwords-form')
		{
