...
// new delhi 28.5274227,77.1387735
      function initMap() {
        var map = new google.maps.Map(document.getElementById('map'), {
          center: {lat: 28.5274227, lng: 77.1387735},
          zoom: 6
        });
...
console.log(place)
			window.parent.document.getElementById('google_place_id').value = place.place_id;
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCkhfzw_JLdFtJkwkHEUNBtsHm_GRNF59Y&libraries=places&callback=initMap"
        async defer></script>
    ...
    public function actionAdmin()
    {
    	if(isset($_POST['google_place_id'])){
    		City::getCityFromGoogle($_POST['google_place_id']);
    	}
