...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'followerUserId'); ?>
		<?php echo $form->textField($model,'followerUserId',array('size'=>10,'maxlength'=>10)); ?>
		<?php echo $form->error($model,'followerUserId'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'followedUserId'); ?>
		<?php echo $form->textField($model,'followedUserId',array('size'=>10,'maxlength'=>10)); ?>
		<?php echo $form->error($model,'followedUserId'); ?>
	</div>
